...
public:
   ...
   HRESULT LoadFromStream(IStream* pSrcStream)
   {
      ATLASSERT(pSrcStream != NULL);
      Delete();
      return ::ILLoadFromStreamEx(pSrcStream, (PIDLIST_RELATIVE*) &m_p);
   }

   HRESULT SaveToStream(IStream* pDstStream)
   {
      ATLASSERT(pDstStream != NULL);
      return ::ILSaveToStream(pDstStream, (PIDLIST_RELATIVE) m_p);
   }
